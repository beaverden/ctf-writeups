...
public class LinearSystem {
    ...
    public SolverVariable createObjectVariable(Object obj) {
        ...
        if (obj instanceof ConstraintAnchor) {
            ...
            if (solverVariable.f3id == -1 || solverVariable.f3id > this.mVariablesID || this.mCache.mIndexedVariables[solverVariable.f3id] == null) {
                if (solverVariable.f3id != -1) {
                    solverVariable.reset();
                }
                this.mVariablesID++;
                this.mNumColumns++;
                solverVariable.f3id = this.mVariablesID;
