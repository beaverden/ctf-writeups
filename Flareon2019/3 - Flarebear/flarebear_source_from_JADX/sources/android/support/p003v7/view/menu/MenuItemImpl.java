...
public final class MenuItemImpl implements SupportMenuItem {
    ...
    public String getShortcutLabel() {
        ...
        if (ViewConfiguration.get(this.mMenu.getContext()).hasPermanentMenuKey()) {
            sb.append(resources.getString(C0207R.string.abc_prepend_shortcut_label));
        }
        int i = this.mMenu.isQwertyMode() ? this.mShortcutAlphabeticModifiers : this.mShortcutNumericModifiers;
        appendModifier(sb, i, 65536, resources.getString(C0207R.string.abc_menu_meta_shortcut_label));
        appendModifier(sb, i, 4096, resources.getString(C0207R.string.abc_menu_ctrl_shortcut_label));
        appendModifier(sb, i, 2, resources.getString(C0207R.string.abc_menu_alt_shortcut_label));
        appendModifier(sb, i, 1, resources.getString(C0207R.string.abc_menu_shift_shortcut_label));
        appendModifier(sb, i, 4, resources.getString(C0207R.string.abc_menu_sym_shortcut_label));
        appendModifier(sb, i, 8, resources.getString(C0207R.string.abc_menu_function_shortcut_label));
        if (shortcut == 8) {
            sb.append(resources.getString(C0207R.string.abc_menu_delete_shortcut_label));
        } else if (shortcut == 10) {
            sb.append(resources.getString(C0207R.string.abc_menu_enter_shortcut_label));
        } else if (shortcut != ' ') {
            sb.append(shortcut);
        } else {
            sb.append(resources.getString(C0207R.string.abc_menu_space_shortcut_label));
        }
        return sb.toString();
    }
