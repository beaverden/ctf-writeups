...
public class AppCompatViewInflater {
    ...
    private static Context themifyContext(Context context, AttributeSet attributeSet, boolean z, boolean z2) {
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0207R.styleable.View, 0, 0);
        int resourceId = z ? obtainStyledAttributes.getResourceId(C0207R.styleable.View_android_theme, 0) : 0;
        if (z2 && resourceId == 0) {
            resourceId = obtainStyledAttributes.getResourceId(C0207R.styleable.View_theme, 0);
            if (resourceId != 0) {
