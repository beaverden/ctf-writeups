...
public class WindowDecorActionBar extends ActionBar implements ActionBarVisibilityCallback {
    ...
    private void init(View view) {
        this.mOverlayLayout = (ActionBarOverlayLayout) view.findViewById(C0207R.C0209id.decor_content_parent);
        ActionBarOverlayLayout actionBarOverlayLayout = this.mOverlayLayout;
        if (actionBarOverlayLayout != null) {
            actionBarOverlayLayout.setActionBarVisibilityCallback(this);
        }
        this.mDecorToolbar = getDecorToolbar(view.findViewById(C0207R.C0209id.action_bar));
        this.mContextView = (ActionBarContextView) view.findViewById(C0207R.C0209id.action_context_bar);
        this.mContainerView = (ActionBarContainer) view.findViewById(C0207R.C0209id.action_bar_container);
        ...
        TypedArray obtainStyledAttributes = this.mContext.obtainStyledAttributes(null, C0207R.styleable.ActionBar, C0207R.attr.actionBarStyle, 0);
        if (obtainStyledAttributes.getBoolean(C0207R.styleable.ActionBar_hideOnContentScroll, false)) {
            setHideOnContentScrollEnabled(true);
        }
        int dimensionPixelSize = obtainStyledAttributes.getDimensionPixelSize(C0207R.styleable.ActionBar_elevation, 0);
    ...
    public Context getThemedContext() {
        if (this.mThemedContext == null) {
            ...
            this.mContext.getTheme().resolveAttribute(C0207R.attr.actionBarWidgetTheme, typedValue, true);
