...
public class AlertDialog extends AppCompatDialog implements DialogInterface {
    ...
    public static class Builder {
        ...
        public Builder(@NonNull Context context, @StyleRes int i) {
            this.f23P = new AlertParams(new ContextThemeWrapper(context, AlertDialog.resolveDialogTheme(context, i)));
            this.mTheme = i;
        }
        ...
        public Builder setTitle(@Nullable CharSequence charSequence) {
            this.f23P.mTitle = charSequence;
            return this;
        }

        public Builder setCustomTitle(@Nullable View view) {
            this.f23P.mCustomTitleView = view;
            return this;
        }
        ...
        public Builder setMessage(@Nullable CharSequence charSequence) {
            this.f23P.mMessage = charSequence;
            return this;
        }
        ...
        public Builder setIcon(@Nullable Drawable drawable) {
            this.f23P.mIcon = drawable;
            return this;
        }

        public Builder setIconAttribute(@AttrRes int i) {
            TypedValue typedValue = new TypedValue();
            this.f23P.mContext.getTheme().resolveAttribute(i, typedValue, true);
            this.f23P.mIconId = typedValue.resourceId;
            return this;
        }
        ...
        public Builder setPositiveButton(@StringRes int i, OnClickListener onClickListener) {
            ...
            this.f23P.mPositiveButtonListener = onClickListener;
            return this;
        }
        ...
        public Builder setPositiveButtonIcon(Drawable drawable) {
            this.f23P.mPositiveButtonIcon = drawable;
            return this;
        }
        ...
        public Builder setNegativeButton(@StringRes int i, OnClickListener onClickListener) {
            ...
            this.f23P.mNegativeButtonListener = onClickListener;
            return this;
        }
        ...
        public Builder setNegativeButtonIcon(Drawable drawable) {
            this.f23P.mNegativeButtonIcon = drawable;
            return this;
        }
        ...
        public Builder setNeutralButton(@StringRes int i, OnClickListener onClickListener) {
            ...
            this.f23P.mNeutralButtonListener = onClickListener;
            return this;
        }
        ...
        public Builder setNeutralButtonIcon(Drawable drawable) {
            this.f23P.mNeutralButtonIcon = drawable;
            return this;
        }

        public Builder setCancelable(boolean z) {
            this.f23P.mCancelable = z;
            return this;
        }
        ...
        public Builder setItems(@ArrayRes int i, OnClickListener onClickListener) {
            ...
            this.f23P.mOnClickListener = onClickListener;
            return this;
        }
        ...
        public Builder setOnItemSelectedListener(OnItemSelectedListener onItemSelectedListener) {
            this.f23P.mOnItemSelectedListener = onItemSelectedListener;
            return this;
        }
        ...
        public Builder setInverseBackgroundForced(boolean z) {
            this.f23P.mForceInverseBackground = z;
            return this;
        }

        @RestrictTo({Scope.LIBRARY_GROUP})
        public Builder setRecycleOnMeasureEnabled(boolean z) {
            this.f23P.mRecycleOnMeasure = z;
            return this;
        }

        public AlertDialog create() {
            AlertDialog alertDialog = new AlertDialog(this.f23P.mContext, this.mTheme);
            this.f23P.apply(alertDialog.mAlert);
            alertDialog.setCancelable(this.f23P.mCancelable);
            if (this.f23P.mCancelable) {
                alertDialog.setCanceledOnTouchOutside(true);
            }
            alertDialog.setOnCancelListener(this.f23P.mOnCancelListener);
            alertDialog.setOnDismissListener(this.f23P.mOnDismissListener);
            if (this.f23P.mOnKeyListener != null) {
                alertDialog.setOnKeyListener(this.f23P.mOnKeyListener);
            }
            return alertDialog;
        }
    ...
    static int resolveDialogTheme(@NonNull Context context, @StyleRes int i) {
        ...
        TypedValue typedValue = new TypedValue();
        context.getTheme().resolveAttribute(C0207R.attr.alertDialogTheme, typedValue, true);
