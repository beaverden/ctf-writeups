...
public abstract class ActionBar {
    ...
    public static class LayoutParams extends MarginLayoutParams {
        ...
        public LayoutParams(@NonNull Context context, AttributeSet attributeSet) {
            ...
            this.gravity = 0;
            TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0207R.styleable.ActionBarLayout);
            this.gravity = obtainStyledAttributes.getInt(C0207R.styleable.ActionBarLayout_android_layout_gravity, 0);
