...
class AlertController {
    ...
    public static class RecycleListView extends ListView {
        ...
        public RecycleListView(Context context, AttributeSet attributeSet) {
            ...
            TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0207R.styleable.RecycleListView);
            this.mPaddingBottomNoButtons = obtainStyledAttributes.getDimensionPixelOffset(C0207R.styleable.RecycleListView_paddingBottomNoButtons, -1);
            this.mPaddingTopNoTitle = obtainStyledAttributes.getDimensionPixelOffset(C0207R.styleable.RecycleListView_paddingTopNoTitle, -1);
        }
    ...
    private static boolean shouldCenterSingleButton(Context context) {
        ...
        context.getTheme().resolveAttribute(C0207R.attr.alertDialogCenterButtons, typedValue, true);
    ...
    public AlertController(Context context, AppCompatDialog appCompatDialog, Window window) {
        ...
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(null, C0207R.styleable.AlertDialog, C0207R.attr.alertDialogStyle, 0);
        this.mAlertDialogLayout = obtainStyledAttributes.getResourceId(C0207R.styleable.AlertDialog_android_layout, 0);
        this.mButtonPanelSideLayout = obtainStyledAttributes.getResourceId(C0207R.styleable.AlertDialog_buttonPanelSideLayout, 0);
        this.mListLayout = obtainStyledAttributes.getResourceId(C0207R.styleable.AlertDialog_listLayout, 0);
        this.mMultiChoiceItemLayout = obtainStyledAttributes.getResourceId(C0207R.styleable.AlertDialog_multiChoiceItemLayout, 0);
        this.mSingleChoiceItemLayout = obtainStyledAttributes.getResourceId(C0207R.styleable.AlertDialog_singleChoiceItemLayout, 0);
        this.mListItemLayout = obtainStyledAttributes.getResourceId(C0207R.styleable.AlertDialog_listItemLayout, 0);
        this.mShowTitle = obtainStyledAttributes.getBoolean(C0207R.styleable.AlertDialog_showTitle, true);
        this.mButtonIconDimen = obtainStyledAttributes.getDimensionPixelSize(C0207R.styleable.AlertDialog_buttonIconDimen, 0);
    ...
    private void setupView() {
        View findViewById = this.mWindow.findViewById(C0207R.C0209id.parentPanel);
        View findViewById2 = findViewById.findViewById(C0207R.C0209id.topPanel);
        View findViewById3 = findViewById.findViewById(C0207R.C0209id.contentPanel);
        View findViewById4 = findViewById.findViewById(C0207R.C0209id.buttonPanel);
        ViewGroup viewGroup = (ViewGroup) findViewById.findViewById(C0207R.C0209id.customPanel);
        setupCustomContent(viewGroup);
        View findViewById5 = viewGroup.findViewById(C0207R.C0209id.topPanel);
        View findViewById6 = viewGroup.findViewById(C0207R.C0209id.contentPanel);
        View findViewById7 = viewGroup.findViewById(C0207R.C0209id.buttonPanel);
        ...
        if (!z3 && resolvePanel2 != null) {
            View findViewById8 = resolvePanel2.findViewById(C0207R.C0209id.textSpacerNoButtons);
        ...
        if (z2) {
            ...
            if (!(this.mMessage == null && this.mListView == null)) {
                view = resolvePanel.findViewById(C0207R.C0209id.titleDividerNoCustom);
            }
            if (view != null) {
                view.setVisibility(0);
            }
        } else if (resolvePanel2 != null) {
            View findViewById9 = resolvePanel2.findViewById(C0207R.C0209id.textSpacerNoTitle);
    ...
    private void setScrollIndicators(ViewGroup viewGroup, View view, int i, int i2) {
        final View findViewById = this.mWindow.findViewById(C0207R.C0209id.scrollIndicatorUp);
        View findViewById2 = this.mWindow.findViewById(C0207R.C0209id.scrollIndicatorDown);
    ...
    private void setupCustomContent(ViewGroup viewGroup) {
        ...
        if (z) {
            FrameLayout frameLayout = (FrameLayout) this.mWindow.findViewById(C0207R.C0209id.custom);
