...
public class ShareActionProvider extends ActionProvider {
    ...
    public View onCreateActionView() {
        ...
        this.mContext.getTheme().resolveAttribute(C0207R.attr.actionModeShareDrawable, typedValue, true);
    ...
    public void onPrepareSubMenu(SubMenu subMenu) {
        ...
        if (min < activityCount) {
            SubMenu addSubMenu = subMenu.addSubMenu(0, min, min, this.mContext.getString(C0207R.string.abc_activity_chooser_view_see_all));
