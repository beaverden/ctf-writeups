...
public class ActionBarContainer extends FrameLayout {
    ...
    public ActionBarContainer(Context context, AttributeSet attributeSet) {
        ...
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0207R.styleable.ActionBar);
        this.mBackground = obtainStyledAttributes.getDrawable(C0207R.styleable.ActionBar_background);
        this.mStackedBackground = obtainStyledAttributes.getDrawable(C0207R.styleable.ActionBar_backgroundStacked);
        this.mHeight = obtainStyledAttributes.getDimensionPixelSize(C0207R.styleable.ActionBar_height, -1);
        if (getId() == C0207R.C0209id.split_action_bar) {
            this.mIsSplit = true;
            this.mSplitBackground = obtainStyledAttributes.getDrawable(C0207R.styleable.ActionBar_backgroundSplit);
        }
    ...
    public void onLayout(boolean r6, int r7, int r8, int r9, int r10) {
        ...
        L_0x00c5:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: android.support.p003v7.widget.ActionBarContainer.onLayout(boolean, int, int, int, int):void");
    }
}
