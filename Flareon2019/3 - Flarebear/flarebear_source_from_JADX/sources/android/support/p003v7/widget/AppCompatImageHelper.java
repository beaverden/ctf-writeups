...
public class AppCompatImageHelper {
    ...
    public void loadFromAttributes(AttributeSet attributeSet, int i) {
        TintTypedArray obtainStyledAttributes = TintTypedArray.obtainStyledAttributes(this.mView.getContext(), attributeSet, C0207R.styleable.AppCompatImageView, i, 0);
        try {
            Drawable drawable = this.mView.getDrawable();
            if (drawable == null) {
                int resourceId = obtainStyledAttributes.getResourceId(C0207R.styleable.AppCompatImageView_srcCompat, -1);
                if (resourceId != -1) {
            ...
            if (obtainStyledAttributes.hasValue(C0207R.styleable.AppCompatImageView_tint)) {
                ImageViewCompat.setImageTintList(this.mView, obtainStyledAttributes.getColorStateList(C0207R.styleable.AppCompatImageView_tint));
            }
            if (obtainStyledAttributes.hasValue(C0207R.styleable.AppCompatImageView_tintMode)) {
                ImageViewCompat.setImageTintMode(this.mView, DrawableUtils.parseTintMode(obtainStyledAttributes.getInt(C0207R.styleable.AppCompatImageView_tintMode, -1), null));
            }
        } finally {
