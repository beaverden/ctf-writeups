...
public final class AppCompatDrawableManager {
    ...
    private Drawable createDrawableIfNeeded(@NonNull Context context, @DrawableRes int i) {
        ...
        if (i == C0207R.C0208drawable.abc_cab_background_top_material) {
            cachedDrawable = new LayerDrawable(new Drawable[]{getDrawable(context, C0207R.C0208drawable.abc_cab_background_internal_bg), getDrawable(context, C0207R.C0208drawable.abc_cab_background_top_mtrl_alpha)});
        }
        if (cachedDrawable != null) {
    ...
    private Drawable tintDrawable(@NonNull Context context, @DrawableRes int i, boolean z, @NonNull Drawable drawable) {
        ...
        if (tintList != null) {
            ...
            return wrap;
        } else if (i == C0207R.C0208drawable.abc_seekbar_track_material) {
            LayerDrawable layerDrawable = (LayerDrawable) drawable;
            setPorterDuffColorFilter(layerDrawable.findDrawableByLayerId(16908288), ThemeUtils.getThemeAttrColor(context, C0207R.attr.colorControlNormal), DEFAULT_MODE);
            setPorterDuffColorFilter(layerDrawable.findDrawableByLayerId(16908303), ThemeUtils.getThemeAttrColor(context, C0207R.attr.colorControlNormal), DEFAULT_MODE);
            setPorterDuffColorFilter(layerDrawable.findDrawableByLayerId(16908301), ThemeUtils.getThemeAttrColor(context, C0207R.attr.colorControlActivated), DEFAULT_MODE);
            return drawable;
        } else if (i == C0207R.C0208drawable.abc_ratingbar_material || i == C0207R.C0208drawable.abc_ratingbar_indicator_material || i == C0207R.C0208drawable.abc_ratingbar_small_material) {
            LayerDrawable layerDrawable2 = (LayerDrawable) drawable;
            setPorterDuffColorFilter(layerDrawable2.findDrawableByLayerId(16908288), ThemeUtils.getDisabledThemeAttrColor(context, C0207R.attr.colorControlNormal), DEFAULT_MODE);
            setPorterDuffColorFilter(layerDrawable2.findDrawableByLayerId(16908303), ThemeUtils.getThemeAttrColor(context, C0207R.attr.colorControlActivated), DEFAULT_MODE);
            setPorterDuffColorFilter(layerDrawable2.findDrawableByLayerId(16908301), ThemeUtils.getThemeAttrColor(context, C0207R.attr.colorControlActivated), DEFAULT_MODE);
            return drawable;
    ...
    static boolean tintDrawableUsingColorFilter(@android.support.annotation.NonNull android.content.Context r6, @android.support.annotation.DrawableRes int r7, @android.support.annotation.NonNull android.graphics.drawable.Drawable r8) {
        /*
            ...
            int r2 = android.support.p003v7.appcompat.C0207R.attr.colorControlNormal
        L_0x0012:
            r1 = r3
        L_0x0013:
            r7 = r5
        ...
        L_0x0015:
            ...
            int r2 = android.support.p003v7.appcompat.C0207R.attr.colorControlActivated
            goto L_0x0012
        L_0x0020:
            ...
            goto L_0x0012
        L_0x002b:
            int r1 = android.support.p003v7.appcompat.C0207R.C0208drawable.abc_list_divider_mtrl_alpha
            ...
            goto L_0x0013
        L_0x003b:
            int r1 = android.support.p003v7.appcompat.C0207R.C0208drawable.abc_dialog_material_background
    ...
    static Mode getTintMode(int i) {
        if (i == C0207R.C0208drawable.abc_switch_thumb_material) {
    ...
    public synchronized ColorStateList getTintList(@NonNull Context context, @DrawableRes int i) {
        ...
        if (tintListFromCache == null) {
            if (i == C0207R.C0208drawable.abc_edit_text_material) {
                tintListFromCache = AppCompatResources.getColorStateList(context, C0207R.color.abc_tint_edittext);
            } else if (i == C0207R.C0208drawable.abc_switch_track_mtrl_alpha) {
                tintListFromCache = AppCompatResources.getColorStateList(context, C0207R.color.abc_tint_switch_track);
            } else if (i == C0207R.C0208drawable.abc_switch_thumb_material) {
                tintListFromCache = createSwitchThumbColorStateList(context);
            } else if (i == C0207R.C0208drawable.abc_btn_default_mtrl_shape) {
                tintListFromCache = createDefaultButtonColorStateList(context);
            } else if (i == C0207R.C0208drawable.abc_btn_borderless_material) {
                tintListFromCache = createBorderlessButtonColorStateList(context);
            } else if (i == C0207R.C0208drawable.abc_btn_colored_material) {
                tintListFromCache = createColoredButtonColorStateList(context);
            } else {
                if (i != C0207R.C0208drawable.abc_spinner_mtrl_am_alpha) {
                    if (i != C0207R.C0208drawable.abc_spinner_textfield_background_material) {
                        if (arrayContains(TINT_COLOR_CONTROL_NORMAL, i)) {
                            tintListFromCache = ThemeUtils.getThemeAttrColorStateList(context, C0207R.attr.colorControlNormal);
                        } else if (arrayContains(TINT_COLOR_CONTROL_STATE_LIST, i)) {
                            tintListFromCache = AppCompatResources.getColorStateList(context, C0207R.color.abc_tint_default);
                        } else if (arrayContains(TINT_CHECKABLE_BUTTON_LIST, i)) {
                            tintListFromCache = AppCompatResources.getColorStateList(context, C0207R.color.abc_tint_btn_checkable);
                        } else if (i == C0207R.C0208drawable.abc_seekbar_thumb_material) {
                            tintListFromCache = AppCompatResources.getColorStateList(context, C0207R.color.abc_tint_seek_thumb);
                        }
                    }
                }
                tintListFromCache = AppCompatResources.getColorStateList(context, C0207R.color.abc_tint_spinner);
            }
            if (tintListFromCache != null) {
    ...
    private ColorStateList createButtonColorStateList(@NonNull Context context, @ColorInt int i) {
        int themeAttrColor = ThemeUtils.getThemeAttrColor(context, C0207R.attr.colorControlHighlight);
        return new ColorStateList(new int[][]{ThemeUtils.DISABLED_STATE_SET, ThemeUtils.PRESSED_STATE_SET, ThemeUtils.FOCUSED_STATE_SET, ThemeUtils.EMPTY_STATE_SET}, new int[]{ThemeUtils.getDisabledThemeAttrColor(context, C0207R.attr.colorButtonNormal), ColorUtils.compositeColors(themeAttrColor, i), ColorUtils.compositeColors(themeAttrColor, i), i});
    }

    private ColorStateList createSwitchThumbColorStateList(Context context) {
        int[][] iArr = new int[3][];
        int[] iArr2 = new int[3];
        ColorStateList themeAttrColorStateList = ThemeUtils.getThemeAttrColorStateList(context, C0207R.attr.colorSwitchThumbNormal);
        if (themeAttrColorStateList == null || !themeAttrColorStateList.isStateful()) {
            iArr[0] = ThemeUtils.DISABLED_STATE_SET;
            iArr2[0] = ThemeUtils.getDisabledThemeAttrColor(context, C0207R.attr.colorSwitchThumbNormal);
            iArr[1] = ThemeUtils.CHECKED_STATE_SET;
            iArr2[1] = ThemeUtils.getThemeAttrColor(context, C0207R.attr.colorControlActivated);
            iArr[2] = ThemeUtils.EMPTY_STATE_SET;
            iArr2[2] = ThemeUtils.getThemeAttrColor(context, C0207R.attr.colorSwitchThumbNormal);
        } else {
            iArr[0] = ThemeUtils.DISABLED_STATE_SET;
    ...
    private void checkVectorDrawableSetup(@NonNull Context context) {
        if (!this.mHasCheckedVectorDrawableSetup) {
            ...
            Drawable drawable = getDrawable(context, C0207R.C0208drawable.abc_vector_test);
