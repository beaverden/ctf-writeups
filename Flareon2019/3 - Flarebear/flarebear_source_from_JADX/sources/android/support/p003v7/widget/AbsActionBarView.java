...
abstract class AbsActionBarView extends ViewGroup {
    ...
    AbsActionBarView(Context context, AttributeSet attributeSet, int i) {
        ...
        if (!context.getTheme().resolveAttribute(C0207R.attr.actionBarPopupTheme, typedValue, true) || typedValue.resourceId == 0) {
    ...
    public void onConfigurationChanged(Configuration configuration) {
        ...
        TypedArray obtainStyledAttributes = getContext().obtainStyledAttributes(null, C0207R.styleable.ActionBar, C0207R.attr.actionBarStyle, 0);
        setContentHeight(obtainStyledAttributes.getLayoutDimension(C0207R.styleable.ActionBar_height, 0));
