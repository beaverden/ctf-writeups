...
class StateListDrawable extends DrawableContainer {
    ...
    public void inflate(@NonNull Context context, @NonNull Resources resources, @NonNull XmlPullParser xmlPullParser, @NonNull AttributeSet attributeSet, @Nullable Theme theme) throws XmlPullParserException, IOException {
        TypedArray obtainAttributes = TypedArrayUtils.obtainAttributes(resources, theme, attributeSet, C0207R.styleable.StateListDrawable);
        setVisible(obtainAttributes.getBoolean(C0207R.styleable.StateListDrawable_android_visible, true), true);
    ...
    private void updateStateFromTypedArray(TypedArray typedArray) {
        ...
        stateListState.mVariablePadding = typedArray.getBoolean(C0207R.styleable.StateListDrawable_android_variablePadding, stateListState.mVariablePadding);
        stateListState.mConstantSize = typedArray.getBoolean(C0207R.styleable.StateListDrawable_android_constantSize, stateListState.mConstantSize);
        stateListState.mEnterFadeDuration = typedArray.getInt(C0207R.styleable.StateListDrawable_android_enterFadeDuration, stateListState.mEnterFadeDuration);
        stateListState.mExitFadeDuration = typedArray.getInt(C0207R.styleable.StateListDrawable_android_exitFadeDuration, stateListState.mExitFadeDuration);
        stateListState.mDither = typedArray.getBoolean(C0207R.styleable.StateListDrawable_android_dither, stateListState.mDither);
    }
        ...
        while (true) {
            ...
            if (next2 != 1) {
                ...
                if (next2 == 2 && depth2 <= depth && xmlPullParser.getName().equals("item")) {
                    TypedArray obtainAttributes = TypedArrayUtils.obtainAttributes(resources, theme, attributeSet, C0207R.styleable.StateListDrawableItem);
                    Drawable drawable = null;
                    int resourceId = obtainAttributes.getResourceId(C0207R.styleable.StateListDrawableItem_android_drawable, -1);
                    if (resourceId > 0) {
