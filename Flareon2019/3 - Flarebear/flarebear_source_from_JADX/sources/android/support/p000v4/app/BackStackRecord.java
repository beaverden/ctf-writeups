...
final class BackStackRecord extends FragmentTransaction implements BackStackEntry, OpGenerator {
    ...
    static final class C0078Op {
        ...
        C0078Op(int i, Fragment fragment2) {
            this.cmd = i;
    ...
    public void dump(String str, PrintWriter printWriter, boolean z) {
        ...
        if (!this.mOps.isEmpty()) {
            ...
            for (int i = 0; i < size; i++) {
                C0078Op op = (C0078Op) this.mOps.get(i);
                switch (op.cmd) {
                    case 0:
                        str2 = "NULL";
                        break;
    ...
    public void bumpBackStackNesting(int i) {
        if (this.mAddToBackStack) {
            ...
            for (int i2 = 0; i2 < size; i2++) {
                C0078Op op = (C0078Op) this.mOps.get(i2);
                if (op.fragment != null) {
    ...
    public boolean interactsWith(ArrayList<BackStackRecord> arrayList, int i, int i2) {
        ...
        for (int i4 = 0; i4 < size; i4++) {
            C0078Op op = (C0078Op) this.mOps.get(i4);
            ...
            if (!(i5 == 0 || i5 == i3)) {
                for (int i6 = i; i6 < i2; i6++) {
                    ...
                    for (int i7 = 0; i7 < size2; i7++) {
                        C0078Op op2 = (C0078Op) backStackRecord.mOps.get(i7);
    ...
    public void executePopOps(boolean z) {
        for (int size = this.mOps.size() - 1; size >= 0; size--) {
            C0078Op op = (C0078Op) this.mOps.get(size);
            Fragment fragment = op.fragment;
            if (fragment != null) {
            ...
            if (i2 != 1) {
                if (i2 == 2) {
                        ...
                        if (fragment5.mContainerId == i3) {
                            if (fragment5 == fragment3) {
                                ...
                                if (fragment5 == fragment4) {
                                    this.mOps.add(i4, new C0078Op(9, fragment5));
                                    i4++;
                                    fragment4 = null;
                                }
                                C0078Op op2 = new C0078Op(3, fragment5);
                    ...
                    if (op.fragment == fragment2) {
                        this.mOps.add(i, new C0078Op(9, op.fragment));
                        i++;
                        fragment2 = null;
                    }
                } else if (i2 != 7) {
                    if (i2 == 8) {
                        this.mOps.add(i, new C0078Op(9, fragment2));
                        i++;
    ...
    public boolean isPostponed() {
        for (int i = 0; i < this.mOps.size(); i++) {
            if (isFragmentPostponed((C0078Op) this.mOps.get(i))) {
                return true;
            }
        }
        return false;
