\u000e¢\u0006\u000e\n\u0000\u001a\u0004\b\u0005\u0010\u0006\"\u0004\b\u0007\u0010\b¨\u0006B"}, mo6118d2 = {"Lcom/fireeye/flarebear/FlareBearActivity;", "Landroid/support/v7/app/AppCompatActivity;", "()V", "handler", "Landroid/os/Handler;", "getHandler", "()Landroid/os/Handler;", "setHandler", "(Landroid/os/Handler;)V", "activityUi", "", "drawable", "Landroid/graphics/drawable/Drawable;", "drawable2", "addPooUi", "Landroid/widget/ImageView;", "addPoos", "changeClean", "clean", "", "changeFlareBearImage", "changeHappy", "happy", "changeImageAndTag", "changeMass", "mass", "view", "Landroid/view/View;", "cleanUi", "dance", "danceWithFlag", "decrypt", "", "password", "", "data", "feed", "feedUi", "getPassword", "getStat", "activity", "", "getState", "", "key", "defValue", "incrementPooCount", "isEcstatic", "", "isHappy", "onCreate", "savedInstanceState", "Landroid/os/Bundle;", "play", "playUi", "removePoo", "restorePoo", "saveActivity", "activityType", "setFlareBearName", "setMood", "setState", "value", "rotN", "n", "Companion", "app_release"}, mo6119k = 1, mo6120mv = {1, 1, 15})
...
public final class FlareBearActivity extends AppCompatActivity {
    ...
    @Metadata(mo6116bv = {1, 0, 3}, mo6117d1 = {"\u0000\u0012\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0010\u000e\n\u0000\b\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002R\u000e\u0010\u0003\u001a\u00020\u0004XT¢\u0006\u0002\n\u0000¨\u0006\u0005"}, mo6118d2 = {"Lcom/fireeye/flarebear/FlareBearActivity$Companion;", "", "()V", "FLARE_BEAR_NAME", "", "app_release"}, mo6119k = 1, mo6120mv = {1, 1, 15})
    /* compiled from: FlareBearActivity.kt */
    ...
    public void onCreate(@Nullable Bundle bundle) {
        ...
        setContentView((int) C0272R.layout.activity_flare_bear);
        setFlareBearName();
    ...
    public final void setFlareBearName() {
        ...
        TextView textView = (TextView) _$_findCachedViewById(C0272R.C0274id.textViewFlareBearName);
        Intrinsics.checkExpressionValueIsNotNull(textView, "textViewFlareBearName");
        textView.setText(getString(C0272R.string.name_heading_format, new Object[]{state}));
    }
    ...
    public final void changeImageAndTag() {
        ImageView imageView = (ImageView) _$_findCachedViewById(C0272R.C0274id.flareBearImageView);
        ...
        if (Intrinsics.areEqual(imageView.getTag(), (Object) str2)) {
            ((ImageView) _$_findCachedViewById(C0272R.C0274id.flareBearImageView)).setImageDrawable(ResourcesCompat.getDrawable(getResources(), C0272R.C0273drawable.happy2, null));
            ((ImageView) _$_findCachedViewById(C0272R.C0274id.flareBearImageView)).setTag(str3);
            return;
        }
        ImageView imageView2 = (ImageView) _$_findCachedViewById(C0272R.C0274id.flareBearImageView);
        Intrinsics.checkExpressionValueIsNotNull(imageView2, str);
        if (Intrinsics.areEqual(imageView2.getTag(), (Object) str3)) {
            ((ImageView) _$_findCachedViewById(C0272R.C0274id.flareBearImageView)).setImageDrawable(ResourcesCompat.getDrawable(getResources(), C0272R.C0273drawable.happy, null));
            ((ImageView) _$_findCachedViewById(C0272R.C0274id.flareBearImageView)).setTag(str2);
            return;
        }
        ImageView imageView3 = (ImageView) _$_findCachedViewById(C0272R.C0274id.flareBearImageView);
        Intrinsics.checkExpressionValueIsNotNull(imageView3, str);
        String str4 = "sad";
        String str5 = "sad2";
        if (Intrinsics.areEqual(imageView3.getTag(), (Object) str4)) {
            ((ImageView) _$_findCachedViewById(C0272R.C0274id.flareBearImageView)).setImageDrawable(ResourcesCompat.getDrawable(getResources(), C0272R.C0273drawable.sad2, null));
            ((ImageView) _$_findCachedViewById(C0272R.C0274id.flareBearImageView)).setTag(str5);
            return;
        }
        ImageView imageView4 = (ImageView) _$_findCachedViewById(C0272R.C0274id.flareBearImageView);
        Intrinsics.checkExpressionValueIsNotNull(imageView4, str);
        if (Intrinsics.areEqual(imageView4.getTag(), (Object) str5)) {
            ((ImageView) _$_findCachedViewById(C0272R.C0274id.flareBearImageView)).setImageDrawable(ResourcesCompat.getDrawable(getResources(), C0272R.C0273drawable.sad, null));
            ((ImageView) _$_findCachedViewById(C0272R.C0274id.flareBearImageView)).setTag(str4);
        }
    }
    ...
    public final void feedUi() {
        activityUi(ResourcesCompat.getDrawable(getResources(), C0272R.C0273drawable.eating, null), ResourcesCompat.getDrawable(getResources(), C0272R.C0273drawable.eating2, null));
    }
    ...
    public final ImageView addPooUi() {
        ...
        Integer num = null;
        Drawable drawable = ResourcesCompat.getDrawable(getResources(), C0272R.C0273drawable.poop, null);
        ...
        ((ConstraintLayout) _$_findCachedViewById(C0272R.C0274id.constraintLayout)).addView(imageView);
        return imageView;
    }
    ...
    public final void playUi() {
        activityUi(ResourcesCompat.getDrawable(getResources(), C0272R.C0273drawable.playing, null), ResourcesCompat.getDrawable(getResources(), C0272R.C0273drawable.playing2, null));
    }

    private final void activityUi(Drawable drawable, Drawable drawable2) {
        this.handler.removeCallbacksAndMessages(null);
        ((ImageView) _$_findCachedViewById(C0272R.C0274id.flareBearImageView)).setImageDrawable(drawable);
        ((ImageView) _$_findCachedViewById(C0272R.C0274id.flareBearImageView)).setTag("activity1");
    ...
    public final void cleanUi() {
        if (FlareBearActivityKt.poosList.size() > 0) {
            ((ConstraintLayout) _$_findCachedViewById(C0272R.C0274id.constraintLayout)).removeView((ImageView) FlareBearActivityKt.poosList.remove(FlareBearActivityKt.poosList.size() - 1));
        }
    }
    ...
    public final void danceWithFlag() {
        InputStream openRawResource = getResources().openRawResource(C0272R.raw.ecstatic);
        ...
        InputStream openRawResource2 = getResources().openRawResource(C0272R.raw.ecstatic2);
    ...
    public final void dance(@NotNull Drawable drawable, @NotNull Drawable drawable2) {
        ...
        this.handler.removeCallbacksAndMessages(null);
        ((ImageView) _$_findCachedViewById(C0272R.C0274id.flareBearImageView)).setImageDrawable(drawable);
        ((ImageView) _$_findCachedViewById(C0272R.C0274id.flareBearImageView)).setTag("ecstatic");
