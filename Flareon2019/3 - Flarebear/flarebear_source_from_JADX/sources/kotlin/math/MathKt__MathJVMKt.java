...
class MathKt__MathJVMKt extends MathKt__MathHKt {
    ...
    @InlineOnly
    /* renamed from: ln */
    private static final double m28ln(double d) {
        return Math.log(d);
    }
    ...
    @InlineOnly
    /* renamed from: ln */
    private static final float m29ln(float f) {
