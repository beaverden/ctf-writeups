...
public final class UArraySortingKt {
    ...
    private static final int m325partition4UcCI2c(byte[] bArr, int i, int i2) {
        byte b;
        byte b2 = UByteArray.m100getimpl(bArr, (i + i2) / 2);
        while (i <= i2) {
            while (true) {
                b = b2 & UByte.MAX_VALUE;
                if (Intrinsics.compare((int) UByteArray.m100getimpl(bArr, i) & UByte.MAX_VALUE, (int) b) >= 0) {
                    break;
                }
                i++;
            }
            while (Intrinsics.compare((int) UByteArray.m100getimpl(bArr, i2) & UByte.MAX_VALUE, (int) b) > 0) {
                i2--;
            }
            if (i <= i2) {
                byte b3 = UByteArray.m100getimpl(bArr, i);
                UByteArray.m105setVurrAj0(bArr, i, UByteArray.m100getimpl(bArr, i2));
                UByteArray.m105setVurrAj0(bArr, i2, b3);
                i++;
                i2--;
            }
        }
    ...
    private static final int m326partitionAa5vz7o(short[] sArr, int i, int i2) {
        ...
        while (i <= i2) {
            while (true) {
                ...
                if (Intrinsics.compare((int) UShortArray.m305getimpl(sArr, i) & UShort.MAX_VALUE, (int) s) >= 0) {
                    break;
                }
                i++;
            }
            ...
            if (i <= i2) {
                short s3 = UShortArray.m305getimpl(sArr, i);
                UShortArray.m310set01HTLdE(sArr, i, UShortArray.m305getimpl(sArr, i2));
                UShortArray.m310set01HTLdE(sArr, i2, s3);
                i++;
                i2--;
            }
        }
    ...
    private static final int m327partitionoBK06Vg(int[] iArr, int i, int i2) {
        int i3 = UIntArray.m169getimpl(iArr, (i + i2) / 2);
        while (i <= i2) {
            while (UnsignedKt.uintCompare(UIntArray.m169getimpl(iArr, i), i3) < 0) {
                i++;
            }
            while (UnsignedKt.uintCompare(UIntArray.m169getimpl(iArr, i2), i3) > 0) {
                i2--;
            }
            if (i <= i2) {
                int i4 = UIntArray.m169getimpl(iArr, i);
                UIntArray.m174setVXSXFK8(iArr, i, UIntArray.m169getimpl(iArr, i2));
                UIntArray.m174setVXSXFK8(iArr, i2, i4);
                i++;
                i2--;
            }
        }
    ...
    private static final int m324partitionnroSd4(long[] jArr, int i, int i2) {
        long j = ULongArray.m238getimpl(jArr, (i + i2) / 2);
        while (i <= i2) {
            while (UnsignedKt.ulongCompare(ULongArray.m238getimpl(jArr, i), j) < 0) {
                i++;
            }
            while (UnsignedKt.ulongCompare(ULongArray.m238getimpl(jArr, i2), j) > 0) {
                i2--;
            }
            if (i <= i2) {
                long j2 = ULongArray.m238getimpl(jArr, i);
                ULongArray.m243setk8EXiF4(jArr, i, ULongArray.m238getimpl(jArr, i2));
                ULongArray.m243setk8EXiF4(jArr, i2, j2);
                i++;
                i2--;
            }
        }
    ...
    public static final void m333sortArrayGBYM_sE(@NotNull byte[] bArr) {
        Intrinsics.checkParameterIsNotNull(bArr, "array");
        m329quickSort4UcCI2c(bArr, 0, UByteArray.m101getSizeimpl(bArr) - 1);
    }

    @ExperimentalUnsignedTypes
    /* renamed from: sortArray-rL5Bavg reason: not valid java name */
    public static final void m335sortArrayrL5Bavg(@NotNull short[] sArr) {
    ...
    public static final void m332sortArrayajY9A(@NotNull int[] iArr) {
        Intrinsics.checkParameterIsNotNull(iArr, "array");
        m331quickSortoBK06Vg(iArr, 0, UIntArray.m170getSizeimpl(iArr) - 1);
    }

    @ExperimentalUnsignedTypes
    /* renamed from: sortArray-QwZRm1k reason: not valid java name */
    public static final void m334sortArrayQwZRm1k(@NotNull long[] jArr) {
        Intrinsics.checkParameterIsNotNull(jArr, "array");
        m328quickSortnroSd4(jArr, 0, ULongArray.m239getSizeimpl(jArr) - 1);
    }
}
