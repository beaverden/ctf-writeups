...
public final class UArraysKt {
    ...
    public static final int m348random2D5oskM(@NotNull int[] iArr, @NotNull Random random) {
        Intrinsics.checkParameterIsNotNull(iArr, "$this$random");
        Intrinsics.checkParameterIsNotNull(random, "random");
        if (!UIntArray.m172isEmptyimpl(iArr)) {
            return UIntArray.m169getimpl(iArr, random.nextInt(UIntArray.m170getSizeimpl(iArr)));
        }
    ...
    public static final long m349randomJzugnMA(@NotNull long[] jArr, @NotNull Random random) {
        Intrinsics.checkParameterIsNotNull(jArr, "$this$random");
        Intrinsics.checkParameterIsNotNull(random, "random");
        if (!ULongArray.m241isEmptyimpl(jArr)) {
            return ULongArray.m238getimpl(jArr, random.nextInt(ULongArray.m239getSizeimpl(jArr)));
        }
        throw new NoSuchElementException("Array is empty.");
    }
    ...
    public static final byte m350randomoSF2wD8(@NotNull byte[] bArr, @NotNull Random random) {
        Intrinsics.checkParameterIsNotNull(bArr, "$this$random");
        Intrinsics.checkParameterIsNotNull(random, "random");
        if (!UByteArray.m103isEmptyimpl(bArr)) {
            return UByteArray.m100getimpl(bArr, random.nextInt(UByteArray.m101getSizeimpl(bArr)));
        }
        throw new NoSuchElementException("Array is empty.");
    }
    ...
    public static final short m351randoms5X_as8(@NotNull short[] sArr, @NotNull Random random) {
        Intrinsics.checkParameterIsNotNull(sArr, "$this$random");
        Intrinsics.checkParameterIsNotNull(random, "random");
        if (!UShortArray.m308isEmptyimpl(sArr)) {
            return UShortArray.m305getimpl(sArr, random.nextInt(UShortArray.m306getSizeimpl(sArr)));
        }
        throw new NoSuchElementException("Array is empty.");
    }
    ...
    public static final boolean m336contentEqualsctEhBpI(@NotNull int[] iArr, @NotNull int[] iArr2) {
    ...
    public static final boolean m339contentEqualsus8wMrg(@NotNull long[] jArr, @NotNull long[] jArr2) {
    ...
    public static final boolean m337contentEqualskdPth3s(@NotNull byte[] bArr, @NotNull byte[] bArr2) {
    ...
    public static final boolean m338contentEqualsmazbYpA(@NotNull short[] sArr, @NotNull short[] sArr2) {
    ...
    public static final int m340contentHashCodeajY9A(@NotNull int[] iArr) {
    ...
    public static final int m342contentHashCodeQwZRm1k(@NotNull long[] jArr) {
    ...
    public static final int m341contentHashCodeGBYM_sE(@NotNull byte[] bArr) {
    ...
    public static final int m343contentHashCoderL5Bavg(@NotNull short[] sArr) {
    ...
    public static final String m344contentToStringajY9A(@NotNull int[] iArr) {
    ...
    public static final String m346contentToStringQwZRm1k(@NotNull long[] jArr) {
    ...
    public static final String m345contentToStringGBYM_sE(@NotNull byte[] bArr) {
    ...
    public static final String m347contentToStringrL5Bavg(@NotNull short[] sArr) {
    ...
    public static final UInt[] m352toTypedArrayajY9A(@NotNull int[] iArr) {
        Intrinsics.checkParameterIsNotNull(iArr, "$this$toTypedArray");
        UInt[] uIntArr = new UInt[UIntArray.m170getSizeimpl(iArr)];
        int length = uIntArr.length;
        for (int i = 0; i < length; i++) {
            uIntArr[i] = UInt.m112boximpl(UIntArray.m169getimpl(iArr, i));
        }
        return uIntArr;
    }
    ...
    public static final ULong[] m354toTypedArrayQwZRm1k(@NotNull long[] jArr) {
        Intrinsics.checkParameterIsNotNull(jArr, "$this$toTypedArray");
        ULong[] uLongArr = new ULong[ULongArray.m239getSizeimpl(jArr)];
        int length = uLongArr.length;
        for (int i = 0; i < length; i++) {
            uLongArr[i] = ULong.m181boximpl(ULongArray.m238getimpl(jArr, i));
        }
        return uLongArr;
    }
    ...
    public static final UByte[] m353toTypedArrayGBYM_sE(@NotNull byte[] bArr) {
        Intrinsics.checkParameterIsNotNull(bArr, "$this$toTypedArray");
        UByte[] uByteArr = new UByte[UByteArray.m101getSizeimpl(bArr)];
        int length = uByteArr.length;
        for (int i = 0; i < length; i++) {
            uByteArr[i] = UByte.m45boximpl(UByteArray.m100getimpl(bArr, i));
        }
        return uByteArr;
    }
    ...
    public static final UShort[] m355toTypedArrayrL5Bavg(@NotNull short[] sArr) {
        Intrinsics.checkParameterIsNotNull(sArr, "$this$toTypedArray");
        UShort[] uShortArr = new UShort[UShortArray.m306getSizeimpl(sArr)];
        int length = uShortArr.length;
        for (int i = 0; i < length; i++) {
            uShortArr[i] = UShort.m250boximpl(UShortArray.m305getimpl(sArr, i));
        }
        return uShortArr;
    }
}
