...
@Metadata(mo6116bv = {1, 0, 3}, mo6117d1 = {"\u0000F\n\u0000\n\u0002\u0018\u0002\n\u0002\u0010\u001c\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\u0010\u001e\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\u001a\u001c\u0010\u0000\u001a\u00020\u0001*\b\u0012\u0004\u0012\u00020\u00030\u0002H\u0007ø\u0001\u0000¢\u0006\u0004\b\u0004\u0010\u0005\u001a\u001c\u0010\u0000\u001a\u00020\u0001*\b\u0012\u0004\u0012\u00020\u00010\u0002H\u0007ø\u0001\u0000¢\u0006\u0004\b\u0006\u0010\u0005\u001a\u001c\u0010\u0000\u001a\u00020\u0007*\b\u0012\u0004\u0012\u00020\u00070\u0002H\u0007ø\u0001\u0000¢\u0006\u0004\b\b\u0010\t\u001a\u001c\u0010\u0000\u001a\u00020\u0001*\b\u0012\u0004\u0012\u00020\n0\u0002H\u0007ø\u0001\u0000¢\u0006\u0004\b\u000b\u0010\u0005\u001a\u001a\u0010\f\u001a\u00020\r*\b\u0012\u0004\u0012\u00020\u00030\u000eH\u0007ø\u0001\u0000¢\u0006\u0002\u0010\u000f\u001a\u001a\u0010\u0010\u001a\u00020\u0011*\b\u0012\u0004\u0012\u00020\u00010\u000eH\u0007ø\u0001\u0000¢\u0006\u0002\u0010\u0012\u001a\u001a\u0010\u0013\u001a\u00020\u0014*\b\u0012\u0004\u0012\u00020\u00070\u000eH\u0007ø\u0001\u0000¢\u0006\u0002\u0010\u0015\u001a\u001a\u0010\u0016\u001a\u00020\u0017*\b\u0012\u0004\u0012\u00020\n0\u000eH\u0007ø\u0001\u0000¢\u0006\u0002\u0010\u0018\u0002\u0004\n\u0002\b\u0019¨\u0006\u0019"}, mo6118d2 = {"sum", "Lkotlin/UInt;", "", "Lkotlin/UByte;", "sumOfUByte", "(Ljava/lang/Iterable;)I", "sumOfUInt", "Lkotlin/ULong;", "sumOfULong", "(Ljava/lang/Iterable;)J", "Lkotlin/UShort;", "sumOfUShort", "toUByteArray", "Lkotlin/UByteArray;", "", "(Ljava/util/Collection;)[B", "toUIntArray", "Lkotlin/UIntArray;", "(Ljava/util/Collection;)[I", "toULongArray", "Lkotlin/ULongArray;", "(Ljava/util/Collection;)[J", "toUShortArray", "Lkotlin/UShortArray;", "(Ljava/util/Collection;)[S", "kotlin-stdlib"}, mo6119k = 5, mo6120mv = {1, 1, 15}, mo6122xi = 1, mo6123xs = "kotlin/collections/UCollectionsKt")
...
class UCollectionsKt___UCollectionsKt {
    ...
    public static final byte[] toUByteArray(@NotNull Collection<UByte> collection) {
        ...
        byte[] r0 = UByteArray.m94constructorimpl(collection.size());
        int i = 0;
        for (UByte r2 : collection) {
            int i2 = i + 1;
            UByteArray.m105setVurrAj0(r0, i, r2.m92unboximpl());
            i = i2;
        }
        return r0;
    }
    ...
    public static final int[] toUIntArray(@NotNull Collection<UInt> collection) {
        ...
        int[] r0 = UIntArray.m163constructorimpl(collection.size());
        int i = 0;
        for (UInt r2 : collection) {
            int i2 = i + 1;
            UIntArray.m174setVXSXFK8(r0, i, r2.m161unboximpl());
            i = i2;
        }
        return r0;
    }
    ...
    public static final long[] toULongArray(@NotNull Collection<ULong> collection) {
        ...
        long[] r0 = ULongArray.m232constructorimpl(collection.size());
        int i = 0;
        for (ULong r2 : collection) {
            int i2 = i + 1;
            ULongArray.m243setk8EXiF4(r0, i, r2.m230unboximpl());
            i = i2;
        }
        return r0;
    }
    ...
    public static final short[] toUShortArray(@NotNull Collection<UShort> collection) {
        ...
        for (UShort r2 : collection) {
            int i2 = i + 1;
            UShortArray.m310set01HTLdE(r0, i, r2.m297unboximpl());
            i = i2;
        }
        return r0;
    }
    ...
    public static final int sumOfUInt(@NotNull Iterable<UInt> iterable) {
        ...
        for (UInt r1 : iterable) {
            i = UInt.m118constructorimpl(i + r1.m161unboximpl());
        }
        return i;
    }
    ...
    public static final long sumOfULong(@NotNull Iterable<ULong> iterable) {
        ...
        for (ULong r2 : iterable) {
            j = ULong.m187constructorimpl(j + r2.m230unboximpl());
        }
        return j;
    }
    ...
    public static final int sumOfUByte(@NotNull Iterable<UByte> iterable) {
        ...
        for (UByte r1 : iterable) {
            i = UInt.m118constructorimpl(i + UInt.m118constructorimpl(r1.m92unboximpl() & UByte.MAX_VALUE));
        }
        return i;
    }
    ...
    public static final int sumOfUShort(@NotNull Iterable<UShort> iterable) {
        ...
        for (UShort r1 : iterable) {
            i = UInt.m118constructorimpl(i + UInt.m118constructorimpl(r1.m297unboximpl() & UShort.MAX_VALUE));
        }
        return i;
    }
}
